<div class="contianer p-5 shadow-sm rounded-3 mb-3">
    ...
    <p>Ce projet a pour but de nous faire pratiquer le PHP en mode orienté objet avec le pattern MVC. 
        Nous allons créer un site de gestion des matières pour un établissement scolaire. 
        Chaque élève (dans un premier temps, ceux du SIO) pourra se connecter, voir les matières qu'il a, les professeurs, les notes etc...</p>
    <p>Les gars je veux que tout le monde participe, je compte sur vous pour cartonner.</p>
    <p>Si ce projet réussi, on enchaînera avec un site gestion des classes comme l'avait proposé Réphaël. Ensuite, 
