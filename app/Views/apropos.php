<main class="bg-section-1 p-5">
    ...
    <h2 class="text-white mb-5">A propos de GDM yhc</h2>
    ...
    <section class="row g-3 bg-white bg-opacity-75 p-3 rounded">
        ...
        <div class="col-md">
            <p class="text-justifie">
                GDM SIO yhc est un site dédié aux matières du BTS SIO. Il a été conçu pour faciliter les étudiants à
                s'orienter et à connaitre le contenu de leur diplôme.
            </p>
            <p class="text-justifie">
    ...
    <section class="p-5 rounded-3 mb-3 bg-white bg-opacity-75">
        ...
        <p class="text-justifie">Ce projet a pour but de nous faire pratiquer PHP avec le pattern MVC. 
            ...
            Dans un premier temps, chaque élève de BTS SIO pourra se connecter, voir les matières qu'il a, les professeurs, les notes etc...</p>
        <p class="text-justifie">Les gars je veux que tout le monde participe, je compte sur vous pour cartonner.</p>
        <p class="text-justifie">Si ce projet réussi, on enchaînera avec un site gestion des classes comme l'avait proposé Réphaël. Ensuite, 
