...
<section class="bg-section-2 row p-5">
    <div class="col-md">
        <div class="bg-white p-4 rounded">
            <h2>Thème 5 : les mutations au travail
                </h2>
...
<section class="bg-section-3 row p-5">
    <div class="col-md">
        <div class="bg-white p-4 rounded">
            
            <h3>Chapitre 2 - Management 
            <a href="<?= BASE_URL ?>ressources/CEJM2-TH5-MANA.pdf" target="_blank" class="bi bi-file-earmark-arrow-down-fill">
                </a>
            </h3>
    ...
    <div class="col-md">
        ...
        <div class="bg-white p-4 rounded">
            ...
            <ul>
                ...
                <li>Les sources nationnales :
                    <ul>
                        <li>Bloc Constitutionnel</li>
                        <li><i style="opacity: 50%;">Bloc conventionnel (prévaut dans l'ordre)</i></li>
                        <li>Bloc législatif</li>
                        <li>Bloc réglementaire</li>
                    </ul>
                </li>
                <li>Les sources interprofessionnelles :
                    <ul>
                        <li>Convention collective</li>
                        <li>Accords d'entreprise</li>
                        <li>Accord de branches</li>
                        <li>ANI - Accord National Interprofessionnel</li>
                    </ul>
                </li>
            </ul>
        </div>
